    ...
    >
      ...
      {hasClear && (
        <button
          ...
          aria-label="clear"
          onClick={onClear}
          className="self-stretch -m-1 py-1 px-2.5 rounded-full text-ink-400 hover:text-ink-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-ring focus-visible:ring-inset"
        >
