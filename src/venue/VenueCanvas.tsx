...
const TYPE_STYLE: Record<VenueItemType, { fill: string; stroke: string; dash?: string }> = {
  ...
  light_grille4:       { fill: '#fef9c3', stroke: '#ca8a04' },
  light_grille8_stand: { fill: '#fde68a', stroke: '#d97706' },
  light_spot:          { fill: '#ffedd5', stroke: '#ea580c' },
  light_grille4_stand: { fill: '#ecfccb', stroke: '#65a30d' },
